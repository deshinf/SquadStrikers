//Copied from StackOverflow, since Unity doesn't support Tuples.
using UnityEngine;
using System;
...
class Tuple<T1, T2> : IFormattable
{
	...
	public override string ToString() { return ToString(null, System.Globalization.CultureInfo.CurrentCulture); }
